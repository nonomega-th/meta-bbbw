...
do_install_append () {
    ...
    install -m 0644 wl18xx-fw.bin ${D}/lib/firmware/ti-connectivity
    install -m 0644 wl18xx-fw-2.bin ${D}/lib/firmware/ti-connectivity
    install -m 0644 wl18xx-fw-3.bin ${D}/lib/firmware/ti-connectivity
    install -m 0644 wl18xx-fw-4.bin ${D}/lib/firmware/ti-connectivity
    install -m 0644 wl1271-nvs.bin ${D}/lib/firmware/ti-connectivity
    install -m 0644 wl127x-nvs.bin ${D}/lib/firmware/ti-connectivity
}
